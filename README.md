...
10 หน่วยตามหลักสูตร รวม 73 ด่าน — รันด้วย **ตัวแปลภาษา C ย่อส่วน** (`public/c-interp.js`) ที่เขียนขึ้นเองใน JavaScript จำลองหน่วยความจำจริง ทำให้พอยน์เตอร์ / อาร์เรย์ / scanf ทำงานเหมือน C แท้ๆ โดยไม่ต้องมีคอมไพเลอร์:

| หน่วย | เนื้อหา | ด่าน |
|------|---------|------|
| 1 | แนะนำภาษาซี (Introduction to C) — ตามตำราบทที่ 1: ประวัติ, ขั้นตอนพัฒนา, โครงสร้าง 3 ส่วน, คอมเมนต์, กฎการตั้งชื่อ | 8 |
| 2 | โปรแกรม Visual Studio 2022 | 6 |
| 3 | แนวคิดในการเขียนโปรแกรม (Concept of Programming) | 6 |
