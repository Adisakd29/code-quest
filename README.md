...
| 2 | ตัวแปร (Variable) | 5 |
| 3 | ข้อความ (String) | 5 |
| 4 | โครงสร้างข้อมูล (List / Dict) | 6 |
| 5 | ตัวดำเนินการ (Operator) | 5 |
| 6 | เงื่อนไข If-Else | 5 |
| 7 | ลูป For / While | 6 |
| 8 | Flowchart สู่โค้ด | 4 |
| 9 | ฟังก์ชัน (Function) | 5 |
| 10 | 🏆 ด่านบอส: รวมพลัง | 3 |

ฟีเจอร์อื่น:

- **Leaderboard** (`GET /api/leaderboard`) — จัดอันดับตามเลเวล → EXP → จำนวนด่านที่ผ่าน แสดง 20 อันดับแรก พร้อมอันดับของตัวเอง
