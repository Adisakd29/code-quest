...
10 หน่วยตามหลักสูตร รวม 50 ด่าน — รันด้วย **ตัวแปลภาษา C ย่อส่วน** (`public/c-interp.js`) ที่เขียนขึ้นเองใน JavaScript จำลองหน่วยความจำจริง ทำให้พอยน์เตอร์ / อาร์เรย์ / scanf ทำงานเหมือน C แท้ๆ โดยไม่ต้องมีคอมไพเลอร์:

| หน่วย | เนื้อหา | ด่าน |
|------|---------|------|
| 1 | แนะนำภาษาซี (Introduction to C) | 5 |
| 2 | โปรแกรม Visual Studio 2022 | 4 |
| 3 | แนวคิดในการเขียนโปรแกรม (Concept of Programming) | 4 |
...
| 7 | คำสั่งควบคุม (Control Statements) | 6 |
| 8 | อาร์เรย์ (Array) | 5 |
