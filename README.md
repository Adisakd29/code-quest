...
3 คอร์สสำหรับสายเว็บ รวม **25 หน่วย 150 ด่าน** — รันในเบราว์เซอร์ได้โดยตรง มี**พรีวิวหน้าเว็บสด** (iframe) ใต้ช่องเขียนโค้ด และตรวจคำตอบจาก **DOM + computed style** ไม่ใช่การเทียบข้อความ (ตัวรัน/ตัวตรวจอยู่ใน `public/web-run.js`)
...
- `test-py.js` (73 ด่าน — รันด้วย python3 จริง)
- `test-c.js` (75 ด่าน — รันผ่านตัวแปล CRUN + ตรวจการย่อหน้า)
- `test-web.js` (150 ด่าน — เรนเดอร์ด้วย jsdom แล้วตรวจ DOM/สไตล์)
