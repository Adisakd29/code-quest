...
| 2 | ตัวแปร (Variable) | 7 |
| 3 | ข้อความ (String) | 7 |
| 4 | โครงสร้างข้อมูล (List / Dict) | 8 |
| 5 | ตัวดำเนินการ (Operator) | 7 |
| 6 | เงื่อนไข If-Else | 7 |
| 7 | ลูป For / While | 9 |
| 8 | Flowchart สู่โค้ด | 6 |
| 9 | ฟังก์ชัน (Function) | 7 |
| 10 | 🏆 ด่านบอส: รวมพลัง | 5 |
