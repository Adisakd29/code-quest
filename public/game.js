    ...
    topics: [
      {
        ...
        blurb: "ประวัติภาษาซี ขั้นตอนพัฒนาโปรแกรม โครงสร้าง 3 ส่วน คอมเมนต์ และกฎการตั้งชื่อ — ตามตำราบทที่ 1",
        lesson: [
          ...
          { h: "โครงสร้างของโปรแกรมภาษาซี (3 ส่วน)", p: "<b>1) ส่วนหัวของโปรแกรม</b> — Preprocessing Directives ขึ้นต้นด้วยเครื่องหมาย # เสมอ เช่น #include &lt;stdio.h&gt; บอกคอมไพเลอร์ให้นำเฮดเดอร์ไฟล์ที่รวมการประกาศ printf()/scanf() เข้ามาด้วย • <b>2) ฟังก์ชั่นหลัก main()</b> — ทุกโปรแกรมต้องมี ขอบเขตการทำงานอยู่ในเครื่องหมาย { และ } (ตำราเขียน main() หรือ void main(void) ก็ได้ ความหมายเหมือนกัน แต่มาตรฐานใหม่นิยม int main() คู่กับ return 0;) • <b>3) ส่วนรายละเอียดของโปรแกรม</b> — คำสั่งต่างๆ ที่ให้โปรแกรมทำงานตามที่ออกแบบไว้", code: "#include <stdio.h>\n\nint main() {\n    printf(\"Hello World\");\n    return 0;\n}" },
          { h: "คอมเมนต์ในภาษาซี (2 แบบ)", p: "คอมเมนต์คือหมายเหตุที่คอมไพเลอร์จะข้ามไม่แปลผล: <b>//</b> คอมเมนต์บรรทัดเดียว และ <b>/* ... */</b> คอมเมนต์หลายบรรทัด — ข้อควรระวังตามตำรา: คอมเมนต์แบบหลายบรรทัด<b>ซ้อนกันไม่ได้</b> เช่น /* /* */ */ จะเกิดข้อผิดพลาดตอนคอมไพล์", code: "// คอมเมนต์บรรทัดเดียว\n/* คอมเมนต์\n   หลายบรรทัด */" },
        ...
        stages: [
          {
            ...
            desc: "ตัวอย่างที่ 1.3 ในตำรา — โปรแกรมภาษาซีโปรแกรมแรกของทุกคน สังเกตโครงสร้าง 3 ส่วน: #include, main() และคำสั่งใน { }",
          ...
          },
          {
            ...
            desc: "ตัวอย่างที่ 1.2 ในตำรา — โน้ตยาวหลายบรรทัดใช้ /* เปิด และ */ ปิด ครอบทีเดียวได้ทั้งก้อน (แต่ห้ามซ้อนกันนะ!)",
          ...
          {
            title: "กฎการตั้งชื่อ",
            desc: "แบบฝึกหัดท้ายบทข้อ 5 — ชื่อตัวแปรในโค้ดนี้ผิดกฎ 2 ตัว: ตัวหนึ่งขึ้นต้นด้วยตัวเลข อีกตัวมีช่องว่างในชื่อ",
          ...
          },
          {
            ...
            desc: "แบบฝึกหัดท้ายบทข้อ 4 — ภาษาซีเป็น case-sensitive: score กับ Score ถือเป็นคนละตัวแปรกันโดยสิ้นเชิง!",
          ...
          },
          {
            ...
            desc: "ปิดบทที่ 1: เขียนโปรแกรม C ที่สมบูรณ์ด้วยตัวเองทั้งหมด ครบโครงสร้าง 3 ส่วนตามตำรา",
...
/* ═══════════════ Init ═══════════════ */
const CONTENT_VERSION = 12; // ต้องตรงกับ CONTENT_VERSION ใน server.js
